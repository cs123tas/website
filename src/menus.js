...
window.menus = {
	...
	[localize("&Algos")]: [
		...
		MENU_DIVIDER,
		{
			item: localize("&Brush Solutions"),
			action: ()=> { window.open("/handouts/brush/brush_algo.pdf")
			},
			enabled: false,
			description: localize("Open Brush Algo Solutions."),
		},
		{
			item: localize("&Shapes Solutions"),
			// shortcut: "Ctrl+W", // closes browser tab
			enabled: false,
			description: localize("Open Shapes Algo Solutions."),
		},
		{
			item: localize("&Intersect Solutions"),
			//shortcut: "Ctrl+I",
			enabled: false,
			description: localize("Open Intersect Algo Solutions."),
		},
		{
			item: localize("&Ray Solutions"),
			//shortcut: "Ctrl+E",
			enabled: false,
			description: localize("Open Ray Algo Solutions."),
		},
		{
			item: localize("&Sceneview Solutions"),
			enabled: false,
			description: localize("Open Sceneview Algo Solutions."),
		},
		{
			item: localize("&Filter Solutions"),
			enabled: false,
			description: localize("Open Filter Algo Solutions."),
		}
	],
	[localize("&Labs")]: [
		{
